...
static void sloctp() {
    ...
    while (*ptr) {
        vram_write8(alis.vram, offset++, *ptr++);
    }
}
...
static void sloctc() {
    ...
    alis.varD7 = *(alis.acc++);
    vram_write8(alis.vram, offset, alis.varD7);
}
